...
<script type="text/javascript">
	...
	<body>
	<form class="tableform" name="form1" action="staff.do?method=updateStaff" id="form1" method="post">
    <div class="main_content" id="main" style="height: 430px; width: 1352px; visibility: visible; opacity: 1;">
   <div class="division">
   <c:set var="staff" value="${staffs}"></c:set>
    <input type="hidden" value="${requestScope.mId }" name="mId">
   <input type="hidden" name="id" value="${staff.id }" />
  <table cellspacing="0" cellpadding="0" border="0" width="100%">
  <tbody><tr>
    <th><font color="red">*</font>&nbsp;姓名：</th>
    <td><input onblur="checkUsername(this);" value="${staff.name }" type="text" vtype="text" class="_x_ipt text" required="true" size="20" style="width:136px" name="name" autocomplete="off" />
    <span id="j_username"></span></td>
  </tr>
   <tr>
    <th>所属机构：</th>
    <td><input type="hidden" id="orgId" name="orgId" value="${staff.org.id }" />
    <span id="pname">${staff.org.name }</span>
...
<div class="division">
  ...
  <td>
		...
		<div id="zhezao"><img src="${staff.photo }" width="100px"/></div>
		<c:if test="${!empty msg}">
			<script>
    ...
    <td><input onblur="checkage(this);" value="${staff.age }" type="text" vtype="text" class="_x_ipt text" style="" required="true" size="20" name="age" autocomplete="off" />
    <span id="j_age"></span></td>
  </tr>
      <tr>
    <th><font  color="red">*</font>&nbsp;&nbsp;身份证号码：</th>
    <td><input onblur="checkcardId(this);" value="${staff.cardId }" type="text" vtype="text" class="_x_ipt text" style="" required="true" size="20" name="cardId" autocomplete="off" />
    <span id="j_idCard"></span></td>
      <tr>
    <th><font  color="red">*</font>&nbsp;&nbsp;QQ：</th>
    <td><input onblur="checkqq(this);" value="${staff.qq }" type="text" vtype="text" class="_x_ipt text" style="" required="true" size="20" name="qq" autocomplete="off" />
    <span id="j_qq"></span></td>
  </tr>
   
       <tr>
    <th><font  color="red">*</font>&nbsp;&nbsp;E-mail：</th>
    <td><input onblur="checkmail(this);" value="${staff.mail }" type="text" vtype="text" class="_x_ipt text" style="" required="true" size="20" name="mail" autocomplete="off" />
  ...
  <th> 联系地址：</th>
  <td>    
     <input onblur="checkaddress(this);" value="${staff.address }" type="text" name="address" /><span id="j_address"></span>
  </td>
  </tr>
   <tr>
  <th> 进厂时间：</th>
  <td>    
     <input type="text" name="rtime" value="${staff.rtime }" onfocus="showCalendar(this)" readonly><font color="red">*</font>
  </td>
  </tr>
  <tr>
  <th> 基本工资：</th>
  <td>    
     <input onblur="checkwage(this);" value="${staff.wage }" type="text" name="wage" value="1" />￥
  <span id="j_wage"></span></td>
  </tr>
    <tr>
  <th> 邮编：</th>
  <td>    
     <input onblur="checkzip(this);" value="${staff.zip }" type="text" name="zip"><span id="j_zip"></span>
  </td>
  </tr>
    <tr>
  <th> 移动电话：</th>
  <td>    
     <input onblur="checktel(this);" value="${staff.mobilephone }" type="text" name="mobilephone"><span id="j_tel"></span>
  </td>
  </tr>
    <tr>
  <th> 固定电话：</th>
  <td>    
     <input onblur="checktel2(this);"  value="${staff.telephone }" type="text" name="telephone"><span id="j_tel2"></span>
  </td>
  </tr>
    <tr>
  <th> 描述：</th>
  <td>    
     <input onblur="checktedescribe(this);"   value="${staff.describes }" type="text" name="describes"><span id="j_describe"></span>
  </td>
  </tr>

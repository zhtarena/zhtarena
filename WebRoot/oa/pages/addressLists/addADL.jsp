...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function stateChanged(){
			if(xmlHttp.readyState==4){
				...
				if("<font color='green'>有此用户，可以添加</font>"==unescape(xmlHttp.responseText)){
				    canSubmit=true;
				}else{
					canSubmit=false;
				}
  ...
  <body>
	<form class="tableform" name="form1" action="addressList.do?method=addADL" id="form1" method="post">
...
<div class="division">
  ...
  <tr>
    <th><font color="red">*</font>&nbsp;当前用户名：</th>
    <td>${user.username }</td>
  </tr>
  <tr>
    <th><font  color="red">*</font>&nbsp;&nbsp;联系人姓名：</th>
    <td><input onblur="checklinkman(this);" type="text" vtype="text" class="_x_ipt text" style="" required="true" size="20" name="linkman" autocomplete="off" />
  ...
  <td>    
     <input onblur="checkmsn(this);" type="text" name="msn"><span id="j_msn"></span>
  </td>
  </tr>

...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
	<form class="tableform" name="form1" action="bbs/bbsAction!replyTopic" id="form1" method="post">
...
<a href="bbs/bbsAction!listRoot">[返回留言列表]</a>
  ...
  <tr>
    ...
    <input name="bbs.rootId" type="hidden" value="${param.id}" />
    <input name="bbs.uid" type="hidden" value="${sessionScope.user.id}" />

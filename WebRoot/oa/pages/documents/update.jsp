...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function checkDocname(docname) {
		...
		var dfirstname=document.getElementById("docfirstname");
	...
	<body>
		<form class="tableform" enctype="MULTIPART/FORM-DATA" onsubmit="return j_submit()" name="form1" action="doc.do?method=updateDoc" id="form1"
			method="post">
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%">
						<tbody>
							<tr>
								<td colspan="2">
									您要创建的公文是
									<font color="red">${doc.flow.name }</font>
							...
							<tr>
								...
								<td>
								<input type="hidden" value="${doc.name }" id="docfirstname" name="docfirstname"/>
									<input onblur="checkDocname(this)" type="text" vtype="text"
										class="_x_ipt text" required="true" size="20"
										style="width: 136px" name="name" autocomplete="off" value="${doc.name }"/>
							...
							<tr>
								...
								<td>
									<input type="text" vtype="text" value="${doc.describes }" class="_x_ipt text" style="width: 500px; height: 200px; vertical-align: top;" required="true" size="20" name="describesString" autocomplete="off" />
			...
			<input type="submit" value="修改" name="__" />&nbsp;&nbsp;<input type="button" value="取消" name="__" onclick="javascript:window.history.back(-1);"/>
		</form>
	</body>
</html>

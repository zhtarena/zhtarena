...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	请选择提交到的机构：<font color="blue">	<span id="pname"></span></font><input type="hidden" name="orgid" value=""/>
...
document.getElementById("orgid").value=porgid;
		...
		d.add(0,-1,'OA平台',"javascript:new getPorg(0,'无父机构');void(0);");

...
<a href="">角色管理</a>
» 
  <span class="">修改角色</span>
</div></div>
      <div class="main_content" id="main" style="height: 400px; width: 1352px; visibility: visible; opacity: 1;">
<form onsubmit="javascript:return j_submit();" id="roleform" name="roleform" action="role.do?method=doUpRole" method="post">
<div class="tableform">
    <div class="division">
      <table cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
          ...
          <input onblur="checkname(this);" type="text" name="name" value="${requestScope.role.name }"/><span id="j_name"></span>
            </td>
        </tr>
          <tr>
          <th>优先级:</th>
          <td>
          <input onblur="checkpriority(this);" type="text" name="priority" value="${requestScope.role.priority }"/><span id="j_priority"></span>
            </td>
        </tr>
       <tr>
  <th>角色图片：</th>
  ...
  <td>
					...
					<tr>
					<td>
					 <img src="${requestScope.role.picture }" height="100px"/>
					</td>
					</tr>
						<tr>
							<td>

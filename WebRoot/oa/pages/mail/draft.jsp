...
<a href="">发送邮件</a>
 ...
 <div class="main_content" id="main" style="height: 500px; width: 1352px; visibility: visible; opacity: 1;">
    <form id="sendMail" name="sendMail" action="mail.do?method=sendMail" method="post" enctype="multipart/form-data">
    		...
    		<tr>
    		<td>
    			收件人：<input type="text" name="to" value="${requestScope.send }" style="width:60%;height:20px;"/>
    		</td>
    		</tr>
    		<tr>
    		<td>
    		主&nbsp;&nbsp;&nbsp;&nbsp;题：<input type="text" name="subject" style="width:60%;height:20px; " />
    		</td>
    		</tr>
    		<tr>
    		<td id="att">
	...
	function addNewFile(){
		...
		frm.appendChild(document.createElement("br"));
    		...
    		<div>
				内&nbsp;&nbsp;&nbsp;&nbsp;容：
			<textarea cols="80" id="editor1" name="content" rows="10">Input here</textarea>
			<script type="text/javascript">
			//<![CDATA[
